        ...
        jQuery('#parseRecordForm').on('submit', function(e) {
            ...
            params['successCallbackFunction'] = function( data ) {
                if (data.fail) {
                    ...
                    jQuery('#product-data').html(getProductSelectList('product-select', {{ getProducts(true) }}));
                    jQuery('#location-data').html(getProductSelectList('location-select', {{ getLocations(true) }}));
